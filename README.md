...
在线预览：
[画廊](https://xdx888999.github.io/xdx-lab-design-skill/)  & [大师方法页](https://xdx888999.github.io/xdx-lab-design-skill/masters.html)
...
安装请使用轻量 Skill 仓库；当前仓库保留为展示站点和真实案例资产仓库。
...
- **需要图片时**：如果用户没有提供素材，Agent 默认使用免版权 / 开放授权 / 可商用免费图库图片；若环境无法确认授权，则改用生成式图片、SVG 图示或图案纹理，并在交付中说明来源与处理方式。
